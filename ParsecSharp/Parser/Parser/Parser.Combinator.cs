...
namespace ParsecSharp
{
    public static partial class Parser
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IParser<TToken, IEnumerable<T>> Sequence<TToken, T>(IParser<TToken, T> parser1, IParser<TToken, T> parser2)
            => Sequence(parser1, parser2, (a, b) => (IEnumerable<T>)[a, b]);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IParser<TToken, IEnumerable<T>> Sequence<TToken, T>(IParser<TToken, T> parser1, IParser<TToken, T> parser2, IParser<TToken, T> parser3)
            => Sequence(parser1, parser2, parser3, (a, b, c) => (IEnumerable<T>)[a, b, c]);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IParser<TToken, IEnumerable<T>> Sequence<TToken, T>(IParser<TToken, T> parser1, IParser<TToken, T> parser2, IParser<TToken, T> parser3, IParser<TToken, T> parser4)
            => Sequence(parser1, parser2, parser3, parser4, (a, b, c, d) => (IEnumerable<T>)[a, b, c, d]);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IParser<TToken, IEnumerable<T>> Sequence<TToken, T>(IParser<TToken, T> parser1, IParser<TToken, T> parser2, IParser<TToken, T> parser3, IParser<TToken, T> parser4, IParser<TToken, T> parser5)
            => Sequence(parser1, parser2, parser3, parser4, parser5, (a, b, c, d, e) => (IEnumerable<T>)[a, b, c, d, e]);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IParser<TToken, IEnumerable<T>> Sequence<TToken, T>(IParser<TToken, T> parser1, IParser<TToken, T> parser2, IParser<TToken, T> parser3, IParser<TToken, T> parser4, IParser<TToken, T> parser5, IParser<TToken, T> parser6)
            => Sequence(parser1, parser2, parser3, parser4, parser5, parser6, (a, b, c, d, e, f) => (IEnumerable<T>)[a, b, c, d, e, f]);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IParser<TToken, IEnumerable<T>> Sequence<TToken, T>(IParser<TToken, T> parser1, IParser<TToken, T> parser2, IParser<TToken, T> parser3, IParser<TToken, T> parser4, IParser<TToken, T> parser5, IParser<TToken, T> parser6, IParser<TToken, T> parser7)
            => Sequence(parser1, parser2, parser3, parser4, parser5, parser6, parser7, (a, b, c, d, e, f, g) => (IEnumerable<T>)[a, b, c, d, e, f, g]);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IParser<TToken, IEnumerable<T>> Sequence<TToken, T>(IParser<TToken, T> parser1, IParser<TToken, T> parser2, IParser<TToken, T> parser3, IParser<TToken, T> parser4, IParser<TToken, T> parser5, IParser<TToken, T> parser6, IParser<TToken, T> parser7, IParser<TToken, T> parser8)
